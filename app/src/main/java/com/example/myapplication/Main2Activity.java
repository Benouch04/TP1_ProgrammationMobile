...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(settings.getString("valeur", ""));
        TextView tv1 = (TextView) findViewById(R.id.textView3);
        tv1.setText(settings.getString("valeur", ""));


        Intent intent = getIntent();
        String v= "" ;
        if (intent != null)   v=intent.getStringExtra("idTextView") ;
    ...
    public void setTxTValeur(String valeur) {
        TextView zoneValeur =  findViewById(R.id.textView3);
